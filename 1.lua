-- =================================================================
-- MY CUSTOM BLOX FRUITS HUB (Rayfield UI - Working 100%)
-- =================================================================
...
local function AutoAttack()
    pcall(function()
        ...
        if tool and not LocalPlayer.Character:FindFirstChildOfClass("Tool") then
            ...
            pcall(function()
                ...
                if not LocalPlayer.PlayerGui.Main.Quest.Visible then
                    ...
                    if enemy and enemy:FindFirstChild("Humanoid") and enemy.Humanoid.Health > 0 then
                        ...
                        TweenTo(questCFrame * CFrame.new(0, 20, 0), 300)
                    end
                end
            end)
        end
...
Rayfield:Notify({
   Title = "Thành công!",
   Content = "Menu đã sẵn sàng, bạn hãy bật các công tắc để sử dụng.",
   Duration = 4
})
